...
impl A2aClient {
    ...
    pub async fn resubscribe_task_with_error_handling(
        &mut self,
        task_id: &str,
    ) -> Result<crate::client::streaming::StreamingResponseStream, ClientError> {
    ...
    pub async fn send_task_with_error_handling(
        &mut self,
        task_id: &str,
        text: &str,
    ) -> Result<crate::types::Task, ClientError> {
        ...
        self.send_jsonrpc::<crate::types::Task>("tasks/send", params_value)
            .await
    }

    /// Get a task by ID with improved error handling
    pub async fn get_task_with_error_handling(
        &mut self,
        task_id: &str,
    ) -> Result<crate::types::Task, ClientError> {
        ...
        self.send_jsonrpc::<crate::types::Task>("tasks/get", params_value)
            .await
    }
    ...
    pub async fn cancel_task_with_error_handling(
        &mut self,
        task_id: &str,
        ...
        params.insert(
            ...
            serde_json::Value::String("task_not_cancelable".to_string()),
        );
    ...
    pub async fn send_task_compat(
        &mut self,
        text: &str,
    ) -> Result<crate::types::Task, Box<dyn Error>> {

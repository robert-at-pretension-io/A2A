...
fn test_data_command() {
    ...
    assert_eq!(cmd, "data");
    assert_eq!(args, Some("{\"name\":\"test\"} This is a message with data"));
}
        ...
        match command {
            "session" => {
                if let Some(subcommand) = args {
                    if subcommand == "new" {
                        self.commands_executed.entry("session_new".to_string())
                        ...
                        self.commands_executed.entry("session_show".to_string())
                            .and_modify(|count| *count += 1)
                            .or_insert(1);
            ...
            "history" => {
                self.commands_executed.entry("history".to_string())
                    .and_modify(|count| *count += 1)
                    .or_insert(1);
            ...
            "tasks" => {
                self.commands_executed.entry("tasks".to_string())
                    .and_modify(|count| *count += 1)
                    .or_insert(1);
            ...
            "task" => {
                if let Some(task_id) = args {
                    self.commands_executed.entry("task".to_string())
                        .and_modify(|count| *count += 1)
                        .or_insert(1);
            ...
            "artifacts" => {
                if let Some(task_id) = args {
                    self.commands_executed.entry("artifacts".to_string())
                        .and_modify(|count| *count += 1)
                        .or_insert(1);
            ...
            "cancelTask" => {
                if let Some(task_id) = args {
                    self.commands_executed.entry("cancelTask".to_string())
                        .and_modify(|count| *count += 1)
                        .or_insert(1);
            ...
            "file" => {
                if let Some(args_str) = args {
                    self.commands_executed.entry("file".to_string())
                        .and_modify(|count| *count += 1)
                        .or_insert(1);
            ...
            "data" => {
                if let Some(args_str) = args {
                    self.commands_executed.entry("data".to_string())
                        .and_modify(|count| *count += 1)
                        .or_insert(1);
